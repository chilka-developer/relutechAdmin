 ...
 *
 * @type Object
 * @description $.Application is the main object for the template's app.
 ...
 * - Implementation -
 * ------------------
 * The next block of code implements Application's
...
$(function () {
  ...
  if (o.sidebarPushMenu) {
    $.Application.pushMenu.activate(o.sidebarToggleSelector);
  }
...
function _init() {
  ...
  $.Application.controlSidebar = {
    ...
    activate: function () {
      ...
      var _this = this;
      //Update options
      var o = $.Application.options.controlSidebarOptions;
      //Get the sidebar
